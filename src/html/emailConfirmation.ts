...
export const emailConfirmation = (codeConfirmation: string): string => {
  return `<!DOCTYPE html
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                    cellspacing="0"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:610px">
                                    <tr>
                                        <td align="left"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:34px;color:#333333;font-size:17px;text-align:justify">
                                                                    ...
                                                                    <h1
                                                                        style="Margin:0;line-height:50px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:25px;font-style:normal;font-weight:bold;color:#333333;text-align:center">
                                                                        <strong><span
                                                                                style="font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:27px">${codeConfirmation}</span></strong><strong><span
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" align="center" cellpadding="0" cellspacing="0"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:610px">
                                    <tr>
                                        <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Copyright ${String(
                                                                          process
                                                                            .env
                                                                            .APP_NAME,
                                                                        ).toUpperCase()}® 2022 - Todos os direitos
                                                                        reservados</p>
                                                                </td>
                                                            </tr>
                                                        </table>
